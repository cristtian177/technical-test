...
console.log("Columnas:", matriz[0].length);

// Coordenadas de inicio y fin
const start = [0, 0];
const end = [4, 3];

// Verificación de obstáculos en la celda de inicio y la celda de fin
if (matriz[start[0]][start[1]] === 1) {
  return console.log("El punto de inicio es un obstáculo, no se puede comenzar.");
} else if (matriz[end[0]][end[1]] === 1) {
  return console.log("La meta es un obstáculo, no se puede llegar.");
}

// Se define el número de filas y columnas
...
while (cola.length > 0) {
  ...
  for (const desplazamiento of direcciones) {
    ...
    // Validación de límites, obstáculo 
    if (
...
if (encontrado) {
  ...
  // Se muestra el camino directamente
